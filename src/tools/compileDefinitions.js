  ...
  const types = Object.entries(json)
    .map((pair) => {
      ...
      if (typeof json[key] === 'object' || json[key] instanceof Array) {
        return that.lineDecorator
          .call(env, that.innerWalker(json[key], key, level + 1), parentType);
      }
      if (typeof json[key] === 'string' || typeof json[key] === 'boolean' || typeof json[key] === 'number') {
        return that.lineDecorator
          .call(env, `${typeof json[key]}`, parentType);
      }
